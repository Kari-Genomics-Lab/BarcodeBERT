...
from baselines.embedders import NucleotideTransformerEmbedder
from baselines.embedders import HyenaDNAEmbedder
from baselines.embedders import DNABert2Embedder
from baselines.embedders import DNABertSEmbedder
from baselines.embedders import BarcodeBERTEmbedder
...
def load_baseline_model(backbone_name, *args, **kwargs):
    ...
    backbones = {'NT': NucleotideTransformerEmbedder,
    ...
    checkpoints = {'NT':(['InstaDeepAI/nucleotide-transformer-v2-50m-multi-species'], {}),

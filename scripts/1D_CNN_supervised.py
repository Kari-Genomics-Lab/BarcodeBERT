...
species  =  train[target_level].to_list()
...
X_train, X_test, y_train, y_test = train_test_split(X, np.array(labels), test_size=0.3, random_state=42)
...
torch.save(model.state_dict(), 'model_checkpoints/model_CNN.pth')
